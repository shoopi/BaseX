package main.java.nl.tue.ieis.is.basex.utility;
...
public class MailUtil {
	...
	public static void sendMail(UserTable user) throws MalformedURLException, EmailException {  
	   ...
	   //email.setAuthenticator(new Authenticator("shaya.pourmirza@gmail.com","****"));
